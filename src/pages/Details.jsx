...
const Details = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`https://library-management-system-server-cyan.vercel.app/books/${id}`)
      .then((response) => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        "https://library-management-system-server-cyan.vercel.app/borrow",
        borrowData
      );
      ...
      const updatedBook = await axios.get(`https://library-management-system-server-cyan.vercel.app/books/${id}`);
