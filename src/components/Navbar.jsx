...
//             <img className="w-44 h-28" src={logo2} alt="logo" />
//           </div>
//         </Link>
//       </div>
...
//           </li>
//           <li>
//             <Link to="/jobs">All Books</Link>
//           </li>
//           <li>
//             <Link to="/jobs">Add Book</Link>
//           </li>
//           <li>
//             <Link to="/jobs"> Borrowed Books</Link>
//           </li>
    ...
    <div className="navbar bg-base-100 shadow-sm container mx-auto">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul
            tabIndex={0}
            className="menu menu-sm dropdown-content  mt-3 p-2 shadow bg-base-100 rounded-box z-[1] w-52"
          >
            {navLinks}
            {!user && (
