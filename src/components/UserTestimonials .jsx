  ...
  return (
    <section className="">
      <div className="container px-6 py-10 mx-auto min-h-[calc(100vh-250px)]">
        ...
        <div className="grid grid-cols-1 lg:flex lg:gap-4  lg:px-32">
          <div className="w-full max-w-md px-8 py-4 mt-16 bg-white rounded-lg shadow-lg dark:bg-gray-800">
            <div className="flex justify-center  md:justify-start">
              ...
              <h1 className="mt-2 text-2xl font-semibold text-gray-800 dark:text-white md:mt-0 px-4">Awlad Hossain</h1>
              <p className="uppercase mt-2  font-semibold text-[#737373] dark:text-white md:mt-0 px-4">Student</p>
              </div>
            </div>
          ...
          <div className="w-full max-w-md px-8 py-4 mt-16 bg-white rounded-lg shadow-lg dark:bg-gray-800">
            <div className="flex justify-center  md:justify-start">
              ...
              />
              <div className="grid grid-rows-2">
              <h1 className="mt-2 text-2xl font-semibold text-gray-800 dark:text-white md:mt-0 px-4">Khatab Wedaa</h1>
              <p className="uppercase mt-2  font-semibold text-[#737373] dark:text-white md:mt-0 px-4">Student</p>
              </div>
            </div>
